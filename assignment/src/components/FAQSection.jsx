...
// import { assets, faqList } from "../assets/asset";
...
//             height="48px"
//             width="48px"
//             className="absolute z-0 top-2 right-10" // Adjusted position to be closer to the first image
//           />
...
//             height="48px"
//             width="48px"
//             className="absolute z-0 top-2 left-10" // Adjusted position to be closer to the first image
//           />
//         </div>
...
//           <h1 className="text-[20px] font-bold">Still have questions?</h1>
//           <p className="text-customBlack text-[18px]">
//             Can’t find the answer you’re looking for? Please chat to our
//             friendly team.
//           </p>
//         </div>

//         <button className="bg-customRed text-white rounded-lg px-5 py-3 w-[134px] h-[48px]">
//           Get in touch
//         </button>
//       </div>
//     </div>
